                    ...
                    <TouchableOpacity className="flex-row items-center gap-3">
                        <View className="flex-1">
                            <Text style={{ fontFamily: 'Poppins' }} className="text-sm leading-5">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Error amet provident quae
                                consequuntur, exercitationem temporibus dolor mollitia optio dolorem quod.
                            </Text>
                        </View>
