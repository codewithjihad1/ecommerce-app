...
export default function Checkout() {
    ...
    const openPaymentSheet = async () => {
        ...
        try {
            ...
            Alert.alert(
                "Error", 
                error?.message || "Something went wrong with your order"
            );
        } finally {
            setIsProcessing(false);
        }
        ...
        <SafeAreaView className="flex-1 justify-center p-4">
            ...
            <View className="flex-row items-center justify-between rounded-xl border-t border-gray-200 bg-white px-4 py-4 shadow-current">
                ...
                <Pressable
                    ...
                    className={`rounded-2xl px-10 py-4 ${isProcessing ? 'bg-gray-400' : 'bg-neutral-900 active:opacity-80'}`}
                >
