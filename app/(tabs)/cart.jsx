...
export default function Cart() {
    ...
    const removeProduct = (index) => {
        ...
        setQuantities((prev) => {
            ...
            Object.keys(prev).forEach((key) => {
                ...
                if (oldIndex !== index) {
                    newQuantities[oldIndex < index ? oldIndex : oldIndex - 1] =
                        prev[key];
                }
            });
    ...
    const subtotal = products.reduce(
        (sum, product, index) => sum + product.price * (quantities[index] || 1),
        0,
    );
                    ...
                    <View className="mb-6 bg-white rounded-3xl shadow-lg border border-gray-100 overflow-hidden">
                        <View className="px-5 py-5">
                            ...
                            <Text
                                ...
                                className="text-gray-600 leading-6 pl-11"
                            >
                                26, Duong So 2, Thao Dien Ward, An Phu, District
                                2, Ho Chi Minh city
                            </Text>
                        </View>
                    </View>
                    ...
                    <View className="mb-6">
                        {products.length === 0 ? (
                            <View className="bg-white rounded-3xl p-12 items-center shadow-lg">
                                ...
                                >
                                    <Text className="bg-[#004CFF] px-5 py-3 mt-5 text-white rounded ">
                                        Shop Now
                                    </Text>
                                </TouchableOpacity>
                            </View>
